...
class FishSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('id_num', 'name', 'location', 'rarity', 'month_span', 'is_all_day', 'is_all_year', 'time_info', 'month_info', 'shadow_size', 'icon')
        model = Fish
...
class BugSerializer(serializers.ModelSerializer):
    ...
    month_info = NestedMonthSerializer(many=True, source='month_array')
    class Meta:
        fields = ('id_num', 'name', 'location', 'rarity', 'month_span', 'is_all_day', 'is_all_year', 'time_info', 'month_info', 'icon')
        model = Bug
...
class SeaCreatureSerializer(serializers.ModelSerializer):
    ...
    month_info = NestedMonthSerializer(many=True, source='month_array')
    class Meta:
        fields = ('id_num', 'name', 'month_span', 'is_all_day', 'is_all_year', 'time_info', 'month_info', 'shadow_size', 'speed', 'icon')
        model = SeaCreature
