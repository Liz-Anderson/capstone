...
class CustomUserSerializer (serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('id', 'username', 'caught_fish', 'caught_bugs', 'caught_seacreatures', 'caught_fish_details', 'caught_bugs_details', 'caught_seacreatures_details', 'friends', 'outbound_friend_requests', 'friends_details', 'inbound_friend_requests', 'outbound_friend_requests_details', 'inbound_friend_requests_details')
        model = CustomUser